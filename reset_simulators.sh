...
xcrun simctl create "iPhone 11 Pro (14.1)"         "$iPhone-11-Pro"                          "$iOS-14-1"
xcrun simctl create "iPhone SE 2 (14.1)"           "$iPhone-SE--2nd-generation-"             "$iOS-14-1"

# iPads
xcrun simctl create "iPad Pro (10.5-inch) (14.1)"  "$iPad-Pro--10-5-inch-"                   "$iOS-14-1"
...
xcrun simctl create "iPad Pro (12.9-inch) (14.1)"  "$iPad-Pro--12-9-inch---4th-generation-"  "$iOS-14-1"
