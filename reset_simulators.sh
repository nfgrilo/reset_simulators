...
xcrun simctl create "iPhone SE 2 (13.6)" "$iPhone-SE--2nd-generation-"        "$iOS-13-6"
...
xcrun simctl create "iPhone 11 Pro (13.6)"         "$iPhone-11-Pro"                          "$iOS-13-6"
...
xcrun simctl create "iPad Pro (12.9-inch) (13.6)"  "$iPad-Pro--12-9-inch---4th-generation-"  "$iOS-13-6"
